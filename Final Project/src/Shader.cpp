...
unsigned int Shader::CompileShaders(const char* vertexShader, const char* fragShader)
{
...
void Shader::AddShader(unsigned int ShaderProgram, const char* pShaderText, GLenum ShaderType)
{
...
Shader::Shader(const char* vertexShader, const char* fragShader) {
	CompileShaders(vertexShader, fragShader);
}
